...
import br.edu.ifpb.mt.dac.entidades.f.unidirecional.Colaborador;
...
public class ColaboradorDAO extends DAO {
	...
	public List<Colaborador> getAll() {
		...
		try {
			TypedQuery<Colaborador> query = em.createQuery("SELECT c FROM COLABORADOR_UNI c", Colaborador.class);
